...
import UserActivitiesTable from 'components/Tables/activitiesTable/activitiesTable';
  ...
  return (
    <div className='container flex h-full w-full max-w-[180.75rem] flex-col  overflow-auto px-container-base pb-[2.1rem] md:px-container-md'>
      <div className='flex justify-between '>
        <h3 className=' mb-16 text-base font-semibold md:text-2xl'>User Activities</h3>
      </div>
